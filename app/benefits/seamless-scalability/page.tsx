...
export const metadata: Metadata = {
  title: "Seamless Scalability | Peak Point Services",
  description: "Scale operations on demand to meet fluctuating market needs",
}
...
async function getBenefitData() {
  try {
    ...
    const benefit = benefits.find((b: any) => 
      b.link?.includes('seamless-scalability')
    )
