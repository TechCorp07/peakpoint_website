...
export const metadata: Metadata = {
  title: "Uncompromised Security | Peak Point Services",
  description: "Mitigate risk with bank-grade security and compliance standards",
}
...
async function getBenefitData() {
  try {
    ...
    const benefit = benefits.find((b: any) => 
      b.link?.includes('uncompromised-security')
    )
