...
export const metadata: Metadata = {
  title: "Operational Efficiency | Peak Point Services",
  description: "Reduce operational costs by up to 40% immediately with AI automation and elite talent",
}
...
async function getBenefitData() {
  try {
    ...
    const benefit = benefits.find((b: any) => 
      b.link?.includes('operational-efficiency')
    )
